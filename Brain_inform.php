<html>
    <title>Admin Brain ward records</title>
...
<body id="body_bg">
 <div>
<h1>Chongwe Distric Hospital Brain Records</h1><br>
...
@media screen and (max-width:600px) {
  .navbar a {
    ...
    p{
        color: black;
        background-image:url("img/b/images (1).jpg");
...
<div id="frm">
   ...
   <p>
                ...
                <label>City</label>
				<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</td>
				<input name="t2" type="text" placeholder="Enter City" require>
...
<label>Email</label>
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;:</td>
				<input name="t4" type="email" placeholder="Enter Email" require>
...
{
    mysqli_query($link,"insert into table1 value('$_POST[t1]','$_POST[t2]','$_POST[t3]','$_POST[t4]','$_POST[t5]','$_POST[t6]','$_POST[t7]','$_POST[t8]','$_POST[t9]','$_POST[t10]','$_POST[t11]','$_POST[t12]')"); 
}
